...
//////////////////////////////////////////////////verification end and insurance start////////////////////////////
  ...
  $.ajax({
    type: "POST",
    url: "http://insurance.fourthforce.in/slim_insurance/slim_four_ripsssjs/seen.php?user_ida="+user_ida+"&qualification_id="+qualification_id+"&subco_statuss="+subco_statuss,
    data: formData,
    async: 'true',
    crossDomain: true,
    dataType: 'json',
